...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Siguiente → ",sPrevious:"← Previo"},sEmptyTable:"Información no disponible en la tabla",sInfo:"Mostrar desde _START_ hasta _END_ de _TOTAL_ registros",sInfoEmpty:"Mostrar desde 0 hasta 0 de 0 registros",sInfoFiltered:"(Filtrado desde _MAX_ )",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"_MENU_ registros por página",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Buscar:",sUrl:"",sZeroRecords:"Entradas no encontradas"},oSearch:g.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};S(p.defaults);p.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc","desc"],bSearchable:!0,bSortable:!0,bVisible:!0,fnCreatedCell:null,
